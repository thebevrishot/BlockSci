...
namespace blocksci {
    ...
    struct ChainConfiguration {
        ...
        static ChainConfiguration zcoin(const std::string &chainDir);
        static ChainConfiguration zcoinTestnet(const std::string &chainDir);
    };
    ...
    struct ChainRPCConfiguration {
        ...
        static ChainRPCConfiguration zcoin(const std::string &username, const std::string &password);
        static ChainRPCConfiguration zcoinTestnet(const std::string &username, const std::string &password);
    };
